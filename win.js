function renderWinBox(container) {
    ...
    imgWin.src = './/in.jpg';
    imgWin.classList.add('img_final');
    ...
    container.appendChild(imgWin);
    container.appendChild(backButton);
    container.appendChild(moreButton);
    container.appendChild(img);
};

window.application.blocks['winBox'] = renderWinBox;

function renderWinScreens() {
    ...
    window.application.renderBlock('winBox', container);

    container.appendChild(lobbyForm);

};

window.application.screens['winScreens'] = renderWinScreens;